                                                    ...
                                                    <ul class="nice-scroll">
                                                        <li>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" value="sepatu" name="product_category" id="category_one"
                                                        ...
                                                        <li>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" value="jaket" name="product_category" id="category_two"
                                                        ...
                                                        <li>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" value="kaos" name="product_category" id="category_three"
                                                        ...
                                                        <li>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" value="tas" name="product_category" id="category_four"
                                                        ...
                                                        <li>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" value="syal" name="product_category" id="category_five"
